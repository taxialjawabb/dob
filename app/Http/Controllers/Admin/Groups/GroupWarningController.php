...
class GroupWarningController extends Controller
{
    public function show($type, $id)
    {
        if($type === 'id_expiration_date'){
            ...
            return view('groups.driver.driverWarning', compact(
                'drivers',
                'type',
                'idClear' ,
                'idRemains',
            ...
            return view('groups.driver.driverWarning', compact('drivers', 'type', 'licenseClear' , 'licenseRemains', 'licenseExpired', 'id'));
        }
            ...
            return view('groups.driver.driverWarning', compact('drivers', 'type', 'contractClear' , 'contractRemains', 'contractExpired', 'id'));
        }
            ...
            return view('groups.driver.driverWarning', compact('drivers', 'type', 'clearanceClear' , 'clearanceRemains', 'clearanceExpired', 'id'));
        }
        else{
            return back();
        }
    ...
    public function show_vechile($type, $id)
    {
        ...
        if($type === 'driving_license_expiration_date'){
            ...
            return view('groups.vechile.vechileWarning', compact('vechiles', 'type', 'licenseClear' , 'licenseRemains', 'licenseExpired', 'id'));
        }
            ...
            return view('groups.vechile.vechileWarning', compact('vechiles', 'type', 'insuranceClear' , 'insuranceRemains', 'insuranceExpired', 'id'));
        }
            ...
            return view('groups.vechile.vechileWarning', compact('vechiles', 'type', 'examinationClear' , 'examinationRemains', 'examinationExpired', 'id'));
        }
            ...
            return view('groups.vechile.vechileWarning', compact('vechiles', 'type', 'operatingClear' , 'operatingRemains', 'operatingExpired', 'id'));
        }
        else{
            return back();
        }
