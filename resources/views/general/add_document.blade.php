...
<h5 class="mt-4">أضافة مستند </h5>

<form method="POST" action="{{ url('general/save/document') }}" enctype="multipart/form-data">
    @csrf
    <div class="row">
        ...
        <div class="mt-2 mb-3 col-sm-12 col-lg-6">
            ...
            <input type="text" value="{{ old('document_type') }}" name="document_type" class="form-control"
