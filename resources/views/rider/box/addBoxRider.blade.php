...
<h5 class="mt-4">أضافة سند للعميل</h5>

<form method="POST" action="{{ url('rider/box/add/'. $rider->id) }}"  enctype="multipart/form-data">
    @csrf
    <input type="hidden" id="stakeholder_id" name="rider_id" value="{{ $rider->id }}" required>
    <div class="row">
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            data: {'from': 'rider', 'to':stakeholder, 'id': stakeholder_id},
