...
@section('content')
    <div class="container clearfix">
        ...
        <div class="float-end mt-3">
            <a href="{{ url('rider/box/show/take/' . $rider->id) }}"
                class="btn {{ $type === 'take' ? 'btn-primary' : '' }} rounded-0 m-0">قـبـض</a>
            <a href="{{ url('rider/box/show/spend/' . $rider->id) }}"
                class="btn {{ $type === 'spend' ? 'btn-primary' : '' }} rounded-0 m-0">صــرف</a>
                @if(Auth::user()->isAbleTo('rider_box_add_new'))
                <a href="{{ url('rider/box/add/' . $rider->id) }}" class="btn btn-success rounded-0 m-0">أضـافـة سند</a>
                @endif
            </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-5">
                <h6 class="mt-2">
                    الاسم : <span class="mt-2 bond-name">{{ $rider->name }}</span>
                </h6>
            </div>
