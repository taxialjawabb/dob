...
<div class="container clearfix">
    ...
    <div class="float-end mt-3">    
        @if(Auth::user()->isAbleTo('rider_note_docs_add_new'))    
        <a href="{{url('rider/notes/add/'.$rider->id)}}" class="btn btn-success rounded-0 m-0" >أضـافـة ملاحظة</a>
        @endif
    </div>
</div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form  method="GET" action="{{ url('show/pdf') }}">
                                            @csrf
                                            <input type="hidden" name="url" value="{{'assets/images/riders/notes/'.$note->attached}}">
