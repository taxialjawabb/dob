...
@section('content')
    ...
    <form method="POST" action="{{ url('driver/box/add/' . $driver->id) }}"  enctype="multipart/form-data">
        @csrf
        <input type="hidden" id="stakeholder_id" name="driver_id" value="{{ $driver->id }}" required>
