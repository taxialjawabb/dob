...
<div class="container clearfix">
    ...
    <div class="float-end mt-3">  
        ...
        <a href="{{url('driver/notes/add/'.$driver->id)}}" class="btn btn-success rounded-0 m-0" >أضـافـة ملاحظة</a>
        @endif
    </div>
</div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form  method="GET" action="{{ url('show/pdf') }}">
                                            @csrf
                                            <input type="hidden" name="url" value="{{'assets/images/drivers/notes/'.$note->attached}}">
