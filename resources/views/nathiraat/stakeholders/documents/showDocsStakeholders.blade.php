...
<div class="container clearfix">
    ...
    <div class="float-end mt-3">  
        @if(Auth::user()->isAbleTo('stackHolder_document_add')||Auth::user()->isAbleTo('marketing'))      
        <a href="{{url('nathiraat/stakeholders/documents/add/'.$id)}}" class="btn btn-success rounded-0 m-0" >أضـافـة مستند</a>
        @endif
    </div>
</div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form  method="GET" action="{{ url('show/pdf') }}">
                                                @csrf
                                            <input type="hidden" name="url" value="{{'assets/images/nathriaat/documents/'.$document->attached}}">
