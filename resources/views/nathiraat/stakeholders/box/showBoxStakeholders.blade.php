...
@section('content')
    <div class="container clearfix">
        <h5 class=" mt-4 float-start">عرض السندات من النوع <span
                class="bond-type">{{ $type === 'take' ? 'قـبـض' : 'صــرف' }}</span></h5>
        <div class="float-end mt-3">
            <a href="{{ url('nathiraat/stakeholders/box/show/take/' . $stakeholder->id) }}"
                class="btn {{ $type === 'take' ? 'btn-primary' : '' }} rounded-0 m-0">قـبـض</a>
            <a href="{{ url('nathiraat/stakeholders/box/show/spend/' . $stakeholder->id) }}"
                class="btn {{ $type === 'spend' ? 'btn-primary' : '' }} rounded-0 m-0">صــرف</a>
                
                @if(Auth::user()->isAbleTo('stackHolder_box_add')||Auth::user()->isAbleTo('marketing'))

            <a href="{{ url('nathiraat/stakeholders/box/add/' . $stakeholder->id) }}"
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-5">
                <h6 class="mt-2">
                    الاسم : <span class="mt-2 bond-name">{{ $stakeholder->name }}</span>
                </h6>
            </div>
                                    ...
                                    @if ($bond->bond_photo !== null)
                                        <form method="GET" action="{{ url('show/pdf') }}">
                                            ...
                                            <input type="hidden" name="url"
                                                value="{{ 'assets/images/bond/spend/' . $bond->bond_photo }}">
