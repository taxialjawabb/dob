...
<div class="container clearfix">
    ...
    <div class="float-end mt-3">        
        <a href="{{ url('nathiraat/box/show/take') }}" class="btn {{$type === 'take'? 'btn-primary': ''}} rounded-0 m-0" >قـبـض</a>
        <a href="{{ url('nathiraat/box/show/spend') }}" class="btn {{$type === 'spend'? 'btn-primary': ''}} rounded-0 m-0" >صــرف</a>
        <!-- <a href="{{ url('nathiraat/box/add/')}}" class="btn btn-success rounded-0 m-0" >أضـافـة سند</a> -->
    </div>
</div>
                            ...
                            <tbody>
                                ...
                                <tr class="print{{$bond->id}}">
                                    ...
                                    <td>
                                        ...
                                        @if(Auth::user()->isAbleTo('stackHolder_print_nathiraat'))
  ...
  <div class="modal-dialog">
    ...
    <thead>
      <tr id="bill-name-id">
        ...
        <th colspan="3">
            <p  style="color: black; font-size: 21px;" id="bill-name"></p>
        </th>
        ...
        <script>
            ...
            for(var i =0 ; i < listItem.length; i++){
                listItem[i].addEventListener('click', function(e){
                    ...
                    var bondName = $("."+e.target.id+" .bond-name").text();
