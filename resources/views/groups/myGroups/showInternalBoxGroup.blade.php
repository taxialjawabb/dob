...
<div class="container clearfix">
    ...
    <div class="float-end mt-3">        
        <a href="{{ url('groups/box/show/take/'.$group->id) }}" class="btn {{$type === 'take'? 'btn-primary': ''}} rounded-0 m-0" >قـبـض</a>
        <a href="{{ url('groups/box/show/spend/'.$group->id) }}" class="btn {{$type === 'spend'? 'btn-primary': ''}} rounded-0 m-0" >صــرف</a>
        <a href="{{url('groups/box/add/'.$group->id)}}" class="btn btn-success rounded-0 m-0" >أضـافـة سند للسائق</a>
    </div>
</div>
