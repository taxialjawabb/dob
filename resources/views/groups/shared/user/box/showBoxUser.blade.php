...
<div class="mt-2">
    ...
    <i class="arrow left"></i>
    <a href="{{ url('shared/groups/user/detials/'.$group->id.'/'.$user->id) }}"
        class="btn  text-primary">{{$user->name}}</a>
...
<div class="container clearfix">
    ...
    <div class="float-end mt-3">
        <a href="{{ route('shared.groups.user.box.show', [ 'user'=> $user, 'group'=>$group,'type' => 'take'])  }}"
            class="btn {{$type === 'take'? 'btn-primary': ''}} rounded-0 m-0">قـبـض</a>
        <a href="{{ route('shared.groups.user.box.show', [ 'user'=> $user, 'group'=>$group,'type' => 'spend'])  }}"
            class="btn {{$type === 'spend'? 'btn-primary': ''}} rounded-0 m-0">صــرف</a>
        <a href="{{ route('shared.groups.user.box.add',['user' => $user , 'group' => $group]) }}"
...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-5">
            <h6>
                الاسم : <span class="mt-2 bond-name">{{$user->name}}</span>
            </h6>
        </div>
