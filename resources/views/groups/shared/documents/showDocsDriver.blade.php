...
<div class="container clearfix">
    ...
    <div class="float-end mt-3">
        @if(Auth::user()->isAbleTo('driver_add_note_docs')||Auth::user()->isAbleTo('user_group')||Auth::user()->isAbleTo('manage_group'))
        <a href="{{route('shared.groups.document' , $group)}}" class="btn btn-success rounded-0 m-0" >أضـافـة مستند</a>
        @endif
    </div>
</div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form  method="GET" action="{{ url('show/pdf') }}">
                                                @csrf
                                            <input type="hidden" name="url" value="{{'assets/images/groups/documents/'.$document->attached}}">
