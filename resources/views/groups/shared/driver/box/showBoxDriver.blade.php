...
<div class="mt-2">
    ...
    <i class="arrow left "></i>
    <a href="{{ url($driver->group_id === null? 'driver/details/' . $driver->id:'shared/groups/driver/detials/'.$driver->id .'/'. $driver->group_id) }}"
        class="btn text-primary p-1">{{$driver->name}}</a>
...
<div class="container clearfix">
    ...
    <div class="float-end mt-3">
        <a href="{{ route('shared.groups.driver.box.show', [ 'driver'=> $driver, 'group'=>$group,'type' => 'take'])  }}"
            class="btn {{$type === 'take'? 'btn-primary': ''}} rounded-0 m-0">قـبـض</a>
        <a href="{{ route('shared.groups.driver.box.show', [ 'driver'=> $driver, 'group'=>$group,'type' => 'spend'])  }}"
            class="btn {{$type === 'spend'? 'btn-primary': ''}} rounded-0 m-0">صــرف</a>
        <a href="{{ route('shared.groups.driver.box.add',['driver' => $driver , 'group' => $group]) }}"
