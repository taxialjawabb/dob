...
<div class="container mt-4">
    <div class="clearfix">
        <div class="float-start">
            <h5 class="h5 text-dark mt-2">ضريبة القيمة المضافة للمنشأة {{ $group->name }} </h5>
            <p>
        ...
        <div class="float-end mt-3">
            <form method="GET" action="{{ route('shared.groups.show.tax', [ 'group' => $group]) }}" id='form'>
...
<div class="panel panel-default mt-4">
    ...
    <div class="table-responsive">
        <table class="table " id="datatable">
            ...
            <tbody id="tbody">
                <tr>
                    <form action="{{ route('shared.groups.show.tax.spend', ['group' => $group]) }}" method="post">
                        @csrf
