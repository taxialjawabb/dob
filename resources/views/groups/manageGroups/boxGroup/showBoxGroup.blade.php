...
<div class="container clearfix">
    ...
    <div class="float-end mt-3">
        <a href="{{ route('manage.groups.box.show', ['type' => 'take', 'id' => $group->id]) }}" class="btn {{$type === 'take'? 'btn-primary': ''}} rounded-0 m-0" >قـبـض</a>
        <a href="{{ route('manage.groups.box.show', ['type' => 'spend', 'id' => $group->id]) }}" class="btn {{$type === 'spend'? 'btn-primary': ''}} rounded-0 m-0" >صــرف</a>
        <a href="{{ route('manage.groups.box.add', $group->id) }}" class="btn btn-success rounded-0 m-0" >أضـافـة سند </a>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-5">
            <h6 class="mt-2">
                الاسم : <span class="mt-2 bond-name">{{$group->name}}</span>
            </h6>
        </div>
