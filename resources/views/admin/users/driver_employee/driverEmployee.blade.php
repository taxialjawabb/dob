...
<div class="container clearfix">
    <div class="float-start">
        <h5 class="mt-4 ">سائقين : {{ $type =='active'? 'على رأس العمل': 'مستبعدين او انتظار' }}</h5>
    </div>
            ...
            <tbody>
                ...
                <tr class="user{{ $user->id }}">
                    ...
                    <td>
                        ...
                        <form method="GET" action="{{ url('user/driver/attendance/show') }}" class="d-inline">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="container-fluid mt-1 " id="printable">
                <p class="mb-2 mt-4" style="color: black; font-size: 16px;">تسجيل اليوم للموظف: <span id="username"></span></p>
                <p class="mb-4" style="color: black; font-size: 16px;">تاريخ اليوم: {{ \Carbon\Carbon::now()->format('d-m-y') }}</p>
                <form method="POST" action="{{ url('user/driver/attendance/add') }}" id='form'>
