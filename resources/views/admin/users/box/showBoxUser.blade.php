...
@section('content')
    <div class="container clearfix">
        ...
        <div class="float-end mt-3">
            <a href="{{ url('user/box/show/take/' . $user->id) }}"
                class="btn {{ $type === 'take' ? 'btn-primary' : '' }} rounded-0 m-0">قـبـض</a>
            <a href="{{ url('user/box/show/spend/' . $user->id) }}"
                class="btn {{ $type === 'spend' ? 'btn-primary' : '' }} rounded-0 m-0">صــرف</a>
            <a href="{{ url('user/box/add/' . $user->id) }}" class="btn btn-success rounded-0 m-0">أضـافـة سند</a>
        </div>
    </div>
